...
<body class="antialiased">
    <div class="relative  items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            <a href="{{ route('stripe.subscription') }}"
                                class="ml-4 text-sm text-gray-700 underline">サブスクへ</a>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ route('user.export') }}"
                                    class="ml-4 text-sm text-gray-700 underline">CSVエクスポート</a></div>
                        </div>
        ...
        <div class="remodal w80" data-remodal-id="modal">
            <form id='csvform' action="{{ route('user.export') }}" method="POST">
                @csrf
                <div class='row mb-3'>
                    <div class="col-md-5">
                ...
                <div class='row mb-3'>
                    ...
                    <div class="col-md-5">
                        <input data-provide="datepicker" class="form-control datepicker js-end-date" type="datetime"
                            placeholder="出力終了日" name="end_date" value="" dusk='datepicker_last'>
                    </div>
                </div> <!-- row -->
